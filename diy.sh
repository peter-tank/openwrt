...
'https://github.com/pexcn/openwrt-chinadns-ng.git^chinadns-ng,master^6a0a5ab9eebf1ff3d9d1ac8aeb7219cbf163d328'
...
echo "# remove frpc frps init script & bump to 0.32.0"
